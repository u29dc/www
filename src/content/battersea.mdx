...
<MdxMedia src={['battersea_d1.webp@2']} alt="Visitors silhouetted against sweeping white light trails in the Battersea Experience Room." />

<MdxMedia src={['battersea_a2.webm@2']} alt="A walkthrough of the illuminated Battersea Experience Room." />

<MdxMedia src={['battersea_c1.webp@2']} alt="A monochrome visualization of Battersea Power Station, with its four chimneys framed by leaves." />

<MdxMedia src={['battersea_a1.webm@2']} alt="A visitor stands before vertical bars of light in the Battersea Experience Room." />

<MdxMedia src={['battersea_d2.webp@2']} alt="Visitors beside bright clusters of projected particles on the walls of the Battersea Experience Room." />
