...
<MdxMedia src={['outernet_a1.webm@2']} alt="The exterior of Outernet London displaying the Porsche anniversary presentation." />

<MdxMedia src={['outernet_d1.webp@2']} alt="A particle cloud above flowing lines, arranged as a monochrome and pink presentation collage." />

<MdxMedia src={['outernet_a2.webm@2']} alt="Radiating white lines animate around a dark centre on an Outernet screen." />

<MdxMedia src={['outernet_a1.webp@2']} alt="A dense cloud of particles above a rippling surface, with pink presentation captions." />

<MdxMedia src={['outernet_b1.webm@2']} alt="Clusters of bright particles spread across the Outernet screens." />

<MdxMedia src={['outernet_c1.webm@2']} alt="White strands radiate across the Outernet walls and ceiling." />

<MdxMedia src={['outernet_d3.webp@2']} alt="Visitors beneath a field of bright particles at Outernet, with a pink inset highlighting the installation." />

<MdxMedia src={['outernet_c2.webm@2']} alt="Abstract strands and clustered forms resolve into Porsche lettering." />
