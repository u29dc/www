...
<footer
	class="padding-standard grid h-fit min-h-screen w-full select-none grid-cols-10 bg-black text-white uppercase"
>
	<AtomicGradientBlur position="bottom" size="10rem" fixed={true} />

	<div class="relative z-10 col-span-base row-start-1 h-full">
		<div
			class="padding-standard flex h-full flex-col justify-between gap-4 px-0"
		>
			<div class="grid w-full grid-cols-2 gap-4">
				...
				>
					<div class="font-mono">
						[ Always open to conversations that question premises,
						not just solve within them ]
					</div>
				</LayoutSharedFooterLink>
				<LayoutSharedFooterLink
					title="EMAIL"
